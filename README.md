...
- **ESbuild** ![esbuild](https://img.shields.io/github/package-json/dependency-version/eksplein/website/dev/esbuild?filename=package.json&label=ESbuild&logo=go&logoColor=white&color=00ADD9) — Fast JavaScript/TypeScript bundler and minifier
...
Assuming the server port value is **9494**, GraphQL Playground can now be accessed via `http://localhost:9494/graphql`.
